let statements = {
    insertnewStores: {
        ...
        INSERT INTO INVENTORY.STORES (
         ...
         RETURN STORES_CODE , AR_NAME , EN_NAME  , STORE_TYPE  INTO :R_STORES_CODE, :R_AR_NAME, :R_EN_NAME , :R_STORE_TYPE `,
        returns: ["R_STORES_CODE", "R_AR_NAME", "R_EN_NAME" , "R_STORE_TYPE" ],
        bindings: [],
        qstring: "",
        requireCommit: true
    },
    ...
    selectOnestores:{
        ...
        deleteStores: {
          statement: `UPDATE INVENTORY.STORES
