let statements = {
    insertStoresItems: {
        statement: `
        INSERT INTO INVENTORY.stores_items (
                          stores_items_id,
                          stores_id,
                          items_id,
                          status,
    ...
    getStoreItemByID:{
        ...
        deleteStoreItem: {
          statement: `UPDATE INVENTORY.stores_items
        ...
        getStoresItemsByStoreID:{
            ...
            FROM
                INVENTORY.stores_items I ,ITEMS M
                WHERE I.DELETED = 0 AND I.STATUS !=4 AND I.STORES_ID = :STORES_ID AND upper(M.EN_NAME)  LIKE (upper(:EN_NAME) ||'%') AND I.ITEMS_ID = M.ITEMS_ID`,
                    bindings: [],
                    qstring: "",
                    requireCommit: false
                },
                SearchingForStoresItemsByARName:{
                    ...
                    SELECT 
                      ...
                      FROM
                          INVENTORY.stores_items I ,ITEMS M
                          WHERE I.DELETED = 0 AND I.STATUS !=4 AND I.STORES_ID = :STORES_ID AND upper(M.AR_NAME)  LIKE (upper(:AR_NAME) ||'%') AND I.ITEMS_ID = M.ITEMS_ID`,
                        bindings: [],
                        qstring: "",
                        requireCommit: false
                    },
